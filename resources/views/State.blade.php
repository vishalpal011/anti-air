            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-2">
                            <span class="text-muted fw-light">Location /</span> State
                        </h4>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Deactive State</p>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Active State</p>
                                                </div>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row g-2 pt-3">
                                                                            <div class="col-md-12 mb-0">
                                                                               <select name="regions_name" class="form-control" id="" required>
                                                                                <option value="" selected>Select Regions</option>
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-0">
                                                                        <input type="text"
                                                                            name="State_code"
                                                                            class="form-control"
                                                                            placeholder="State Code" value="{{ $value->state_code }}" required>
                                                                    ...
                                                                    <div class="col mb-0">
                                                                        <input type="text"
                                                                            name="State_name"
                                                                            class="form-control"
                                                                            placeholder="State Name" value="{{ $value->state_name }}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-2 pt-3">
                                                                    <div class="col mb-0">
                                                                       <select name="region_name" class="form-control" id="">
                                                                     
                                                                        <option selected value="{{ $value->region_name }}">{{ $value->region_name }} ( Default Selected )</option>
                                                                            @foreach ($region as $value)
                                                                              <option value="{{$value->region_name}}">{{$value->region_name}}</option>
                                                                            @endforeach
                                                                       </select>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (key, value) {
                    ...
                    $("table#example").append("<tr id='row" + value.id + "'><td>" + value.id + "</td><td>" + value.state_code + "</td><td>" + value.state_name + "</td><td>" + value.region_name + "</td><td>" + status + "</td><td>" + editButton + deleteButton +"</td> </tr>");
                });
            }
            }
        });
