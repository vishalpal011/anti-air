            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-2">
                            <span class="text-muted fw-light">Sales & Announcements /</span> Announcements / Post Video AD's
                        </h4>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Deactive Announcements / Post Video AD's</p>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Active Announcements  / Post Video AD's</p>
                                                </div>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLabel4">
                                                                        Announcements  / Post Video AD's</h5>
                                                                ...
                                                                <form id="aws" method="POST">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row pt-3">
                                                                            <div class="col mb-0">
                                                                                <label for="">Upload Video <b>
                                                                                (Formats : mp4, mov, avi, wmv & max size 2mb)
                                                                                </b></label>
                                                                                <input type="file" name="video"
                                                                                    id="" accept=".mp4, .mov, .avi,.wmv"
                                                                                    class="form-control" required>
                                                                            </div>
                                                                            <div class="col mb-0">
                                                                                <label for="">Start
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $value)
                                            <tr id="row{{ $value->id }}">
                                                ...
                                                <td>{{ $count }}</td>
                                                <td>{{ $value->client->first_name }} {{ $value->client->last_name }}
                                                </td>
                                                <td>{{ optional($value->courier)->courier_display_name }}
                                                </td>
                                                <td>{{ $value->title }}</td>

                                                <td class="video">
                                                     <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#videoModal{{ $value->id }}" > <i class="fas fa-video"></i> &nbsp Video </button>
                                                    </td>
                                            ...
                                            <div class="modal fade" id="exLargeModals{{ $value->id }}"
                                                ...
                                                <div class="modal-dialog modal-xl" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{url('update-video-ad')}}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col mb-0">
                                                                ...
                                                                <div class="row pt-3">
                                                                    <div class="col mb-0">
                                                                        <label for="">Upload Video <b>
                                                                                (Formats : mp4, mov, avi, wmv & max size 2mb)</label>
                                                                        <input type="file" name="video"
                                                                            id="" accept=".mp4, .mov, .avi,.wmv" class="form-control">
                                                                        <br>
                                                                        <video style="height: 159px;"  controls playsinline="playsinline" muted="" preload="yes" autoplay="autoplay" loop="loop" id="vjs_video_739_html5_api" class="video-js" data-setup='{"autoplay":"any"}'>
                                                                            <source src="{{ url('assets/videos/' . $value->video) }}" type="video/mp4">
                                                                      </video>
                                                                    </div>
                                                                    <div class="col mb-0">
                                                                        <label for="">Start
                                                                ...
                                                                <div class="row pt-3">
                                                                    <div class="col mb-0">
                                                                        ...
                                                                        <textarea name="description" id="editors{{ $value->id }}" cols="30" rows="4" class="form-control">{{ $value->description }}</textarea>
                                            ...
                                            @endphp
                                             ...
                                             <!-- video Modal -->
                                                <div class="modal fade" id="videoModal{{ $value->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <video style="height: 315px;"  controls playsinline="playsinline" muted="" preload="yes" autoplay="autoplay" loop="loop" id="vjs_video_739_html5_api" class="video-js" data-setup='{"autoplay":"any"}'> <source src="{{ url('assets/videos/' . $value->video) }}" type="video/mp4">
                                                </div>
                                                </div>
                                            </div>
                                            <!-- video Modal -->
                ...
                @foreach ($data as $value)
                    <script>
                        ClassicEditor
                            .create(document.querySelector('#editors{{ $value->id }}'))
                            .then(editor => {
                                console.log(editor);
                            })
                            .catch(error => {
                                    ...
                                    .then(data => {
                                        ...
                                        if (data.status === 'success') {
                                            ...
                                            setTimeout(function() {
                                                ...
                                                window.location.href = '{{ url('video-ads') }}';
                                            }, 2000);
                                        } 
                                        else {
                                            toastr.options = {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (key, value) {
                    ...
                    var video = '<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#videoModal'+ value.id +'" > <i class="fas fa-video"></i> &nbsp Videos </button>';
                    ...
                    $("table#example").append("<tr id='row" + value.id + "'><td>" + value.id + "</td><td>" + clientFirstName + " " + clientLastName +  "</td><td>" + courierName + "</td><td>" + value.title + "</td><td>" + video + "</td> <td>" + value.start_date + "</td><td>" + value.end_date + "</td><td>" + value.description + "</td><td>" + status + "</td><td>" + editButton + deleteButton +"</td> </tr>");
                });
            }
            }
        });
