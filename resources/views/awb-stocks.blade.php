                                                        ...
                                                        <div class="row g-3" data-select2-id="20">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" id="collapsible-fullname"
                                                                    class="form-control" name="aws_count"
                                                                    placeholder="Waybill Counts" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class="form-label"
                                                                    ...
                                                                    <select class="form-control" name="waybill_type" required>
                                                                        ...
                                                                        <option value="ANTE AIR">ANTE AIR</option>
                                                                        <option value="Reverse-QC">Reverse-QC</option>
                                                                    </select>
                                                            </div>
