            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-2">
                            <span class="text-muted fw-light">Rate Cards /</span> Courier Service
                        </h4>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Deactive Service</p>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Active Service</p>
                                                </div>
                                                                        ...
                                                                        <div class="row g-2">
                                                                            <div class="col mb-0">
                                                                                ...
                                                                                <input type="text"
                                                                                    name="service"
                                                                                    class="form-control"
                                                                                    placeholder="Courier Service" required>
                                                                            </div>
                                                                            <div class="col mb-0">
                                        ...
                                        <div class="modal fade" id="basicModals{{ $value->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel1">
                                                            Edit Courier Service</h5>
                                                        <button type="button" class="btn-close"
                                                            data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <form action="{{url('update-courier-service/'.$value->id)}}" method="post">
                                                        @csrf
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row g-2">
                                                                <div class="col mb-0">
                                                                    ...
                                                                    <input type="text"
                                                                        name="service"
                                                                        class="form-control" value="{{ $value->service }}"
                                                                        placeholder="Courier Service" required>
                                                                </div>
                                                                <div class="col mb-0">
                                                                    <label for="">Status</label>
                                                ...
                                                @if ($value->status == 'true')
                                                <option selected value="{{ $value->status }}">Active (Selected)</option>
                                                @else
                                                <option selected value="{{ $value->status }}">Deactive (Selected)</option>
                                                @endif
                                                                        <option value="true">Active</option>
                                                                        <option value="false">Deactive</option>
                                                                    </select>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            document.getElementById('aws').addEventListener('submit', function(e) {
                                ...
                                fetch("{{ url('create-courier-service') }}", {
                                        method: "POST",
                                        body: formData,
                                        headers: {
                                    ...
                                    .then(data => {
                                        if (data.status === 'success') {
                                            ...
                                            setTimeout(function() {
                                                ...
                                                window.location.href = '{{ url('courier-service') }}';
                                            }, 2000);
                                        } else {
                                            toastr.options = {
                                                "closeButton": true,
    ...
    function deleteModal(id){
     ...
     function data_delete(){
        var id = $('#deleteModal').data('id');
            $.ajax({
                 url: '{{url('delete-courier-service')}}',
                 type: 'post',
                 data: {
                    id:id,
                    _token: '{{csrf_token()}}'
