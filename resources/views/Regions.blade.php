            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-2">
                            <span class="text-muted fw-light">Location /</span> Regions
                        </h4>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Deactive Regions</p>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Active Regions</p>
                                                </div>
                                                                        ...
                                                                        <div class="row g-2">
                                                                            <div class="col mb-0">
                                                                                <input type="text"
                                                                                    name="region_code"
                                                                                    class="form-control"
                                                                                    placeholder="Regions Code" required>
                                                                            </div>
                                                                            <div class="col mb-0">
                                                                                <input type="text"
                                                                                    name="region_name"
                                                                                    class="form-control"
                                                                                    placeholder="Regions Name" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row g-2 pt-3">
                                                                            <div class="col-md-12 mb-0">
                                                                               <select name="country_name" class="form-control" id="" required>
                                            ...
                                            <div class="modal fade" id="basicModals{{ $value->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{url('update-regions')}}" method="post">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="row g-2">
                                                                    <div class="col mb-0">
                                                                        <input type="text"
                                                                            name="region_code"
                                                                            class="form-control"
                                                                            placeholder="Regions Code" value="{{ $value->region_code }}" required>
                                                                            <input type="text"
                                                                            name="id"
                                                                            hidden
                                                                            class="form-control"
                                                                            placeholder="Regions Code" value="{{ $value->id }}">
                                                                    </div>
                                                                    <div class="col mb-0">
                                                                        <input type="text"
                                                                            name="region_name"
                                                                            class="form-control"
                                                                            placeholder="Regions Name" value="{{ $value->region_name }}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-2 pt-3">
                                                                    <div class="col mb-0">
                                                                       <select name="country_name" class="form-control" id="" >
                                                                        {{-- <option  disabled>Select Country</option> --}}
                                                                        <option selected value="{{ $value->country_name }}">{{ $value->country_name }} ( Default Selected )</option>
                                                                            @foreach ($data as $value)
                                                                              <option value="{{$value->country_name}}">{{$value->country_name}}</option>
                                                                            @endforeach
                                                                       </select>
                                    ...
                                    .then(data => {
                                        if (data.status === 'success') {
                                            ...
                                            setTimeout(function() {
                                                ...
                                                window.location.href = '{{ url('Regions') }}';
                                            }, 2000);
                                        } else {
                                            toastr.options = {
                                                "closeButton": true,
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (key, value) {
                    ...
                    $("table#example").append("<tr id='row" + value.id + "'><td>" + value.id + "</td><td>" + value.region_code + "</td><td>" + value.region_name + "</td><td>" + value.country_name + "</td><td>" + status + "</td><td>" + editButton + deleteButton +"</td> </tr>");
                });
            }
            }
        });
