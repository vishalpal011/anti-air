...
<body>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div id="property-features" class="content">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label class="form-label" for="plFurnishingDetails">Item
                                                            Width</label>
                                                        <input name="item_width_cm" class="form-control"
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                    aria-labelledby="pills-home-tab">
                                    <form id="myFormcreate" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4 pt-2">
                                                ...
                                                <textarea class="form-control" name="receiver_address" cols="30" rows="5"> </textarea>
                                            </div>
                                            <div class="col-md-4 pt-2">
                                                <Label>Receiver Address 2</Label>
                                                <textarea class="form-control" name="receiver_address_2" cols="30" rows="5"> </textarea>
                                            </div>
                                            <div class="col-md-4 pt-2">
                                            ...
                                            <div class="col-md-4 pt-2">
                                                ...
                                                <select name="client_id" id="select2Basicss"
                                                    class="select2 form-select form-select-lg"
                                                    data-allow-clear="true">
                                            ...
                                            <div class="col-md-4 pt-2">
                                                <label for="select2Basic" class="form-label">wasrehouse</label>
                                            ...
                                            <div class="col-12 d-flex justify-content-between mt-4">
                                                <button type="submit" class="btn btn-success "><span>Submit</span><i
                                                        class="ti ti-check ti-xs"></i></button>
                                            </div>
                                        </div>
                                    </form>
    ...
    <script>
        $(document).ready(function() {
            $('#myFormcreate').submit(function(e) {
                e.preventDefault(); // Prevent default form submission

                var formData = $(this).serialize(); // Serialize form data

                // Uncomment AJAX request
                $.ajax({
                    url: '{{ url('create-booking-b2c-manual') }}',
                    type: 'POST',
                    data: formData,
    ...
    <script>
        $(document).ready(function() {
            // Attach change event listener to the select element
            $('#select2Basicss').on('change', function() {
                // Get the selected value
                var selectedClientId = $(this).val();
