...
<!-- Mirrored from demos.pixinvent.com/vuexy-html-admin-template/html/vertical-menu-template/auth-forgot-password-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Dec 2023 06:09:19 GMT -->
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ url('send-otp') }}" method="post">
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" class="form-control" id="pincode" name="email"
                                    placeholder="Enter your email" autofocus>
                            </div>
                            <div class="mb-3" style="display: none" id="successDiv">
                                <label for="email" class="form-label">OTP</label>
                                <input type="text" class="form-control"   name="email"
                                    placeholder="Enter your OTP" autofocus>
                            </div>
                            <button type="button" id="sendOTPButton" class="btn btn-primary d-grid w-100">Send
                                OTP</button>
                        </form>
