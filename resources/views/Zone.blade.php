            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-2">
                            <span class="text-muted fw-light">Location /</span> Zone
                        </h4>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Deactive Zone</p>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Active Zone</p>
                                                </div>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row g-2">
                                                                            <div class="col mb-0">
                                                                                ...
                                                                                <input type="text" id="search_origin" class="form-control" placeholder="Search...">
                                                                              
                                                                            </div>
                                                                            <div class="col mb-0">
                                                                                
                                                                                <label for="origin_name">Origins</label>
                                                                                <select id="origin_select" name="origin" class="form-control" required>
                                                                        ...
                                                                        <div class="row g-2">
                                                                            <div class="col mb-0">
                                                                                ...
                                                                                <input type="text" id="search_destination" class="form-control" placeholder="Search...">
                                                                        ...
                                                                        <div class="row g-2">
                                                                            <div class="col mb-0">
                                                                                ...
                                                                                <input type="text" class="form-control" name="zone_type" placeholder="Zone Type" required>
                                                                            </div>
                                                                            <div class="col mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $value)
                                            <tr id="row{{ $value->id }}">
                                                ...
                                                <td>{{ $count }}</td>
                                                <td>{{ $value->origin }}</td>
                                                <td>{{ $value->origin_pincode }}</td>
                                                <td>{{ $value->destination }}</td>
                                                <td>{{ $value->destination_pincode }}</td>
                                                <td>{{ $value->zone_type }}</td>
                                            ...
                                            <div class="modal fade" id="basicModals{{ $value->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{url('update-zone')}}" method="post">
                                                            @csrf
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row g-2">
                                                                    ...
                                                                    <div class="col mb-0">
                                                                        ...
                                                                        <label for="origin_name">Origins</label>
                                                                        <select id="origin_select" name="origin" class="form-control">
                                                                            <option value="" selected>--Select--</option>
                                                                        </select>
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-0">
                                                                        <label for="">Zone</label>
                                                                        <input type="text" class="form-control" name="zone_type" value="{{ $value->zone_type }}" placeholder="Zone Type" required>
                                                                    </div>
                                                                    <div class="col mb-0">
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (key, value) {
                    ...
                    $("table#example").append("<tr id='row" + value.id + "'><td>" + value.id + "</td><td>" + value.origin + "</td><td>" + value.destination + "</td><td>" + value.zone_type + "</td><td>" + status + "</td><td>" + editButton + deleteButton +"</td> </tr>");
                });
            }
            }
        });
...
$(document).ready(function() {
    // Function to fetch and populate select options based on search
    function Destination(search_destination) {
        $.ajax({
            url: '{{url('search-pin-codes')}}',
            method: 'POST',
            data: { 
                search: search_destination,
                _token: '{{ csrf_token() }}'
             },
            success: function(response) {
                // Clear existing options
                var names = response.name;
                var pinCodes = response.pin_code;
                // Clear existing options
                $('#destination').empty();
                // Add new options
                for (var i = 0; i < names.length; i++) {
                    $('#destination').append('<option value="' + names[i] +',' +pinCodes[i]+ '">' + names[i] + '  (' + pinCodes[i] + ')</option>');
                }
            },
    ...
    function Origins(search_origin) {
        $.ajax({
            url: '{{url('search-pin-codes')}}',
            method: 'POST',
            data: { 
                search: search_origin,
                _token: '{{ csrf_token() }}'
             },
            success: function(response) {
                // Clear existing options
                ...
                // Add new options
                for (var i = 0; i < names.length; i++) {
                    $('#origin_select').append('<option value="' + names[i] +',' +pinCodes[i]+  '">' + names[i] + '  (' + pinCodes[i] + ')</option>');
                }
            },
            error: function(xhr, status, error) {
                console.error('Error fetching data: ', error);
    ...
    $('#search_destination').on('keyup', function() {
        var search_destination = $(this).val();
        Destination(search_destination);
    });


    $('#search_origin').on('keyup', function() {
        var search_origin = $(this).val();
