            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-2">
                            <span class="text-muted fw-light">Location /</span> Pin Code
                        </h4>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Deactive Pin Code</p>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Active Pin Code</p>
                                                </div>
                                                                ...
                                                                <form id="aws" method="post">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row g-2">
                                                                            ...
                                                                            <div class="col mb-0">
                                                                                 <select name="city_name" id="" class="form-control" required>
                                            ...
                                            <div class="modal fade" id="basicModals{{ $value->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{url('update-pin-code')}}" method="post">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="row g-2">
                                                                    ...
                                                                    <div class="col mb-0">
                                                                        <input type="text"
                                                                            name="pin_code"
                                                                            class="form-control"
                                                                            placeholder="City Code" value="{{ $value->pin_code }}" required>
                                                                            <input type="text" hidden name="id" value="{{ $value->id }}">
                                                                    </div>
                                                                    <div class="col mb-0">
                                                                        <select name="city_name" id="" class="form-control">

                                                                            <option selected value="{{ $value->city_name }}">{{ $value->city_name }} ( Defualt Selected )</option>
                                                                            @foreach ($city as $values)
                                                                                <option value="{{$values->city_name}}">{{$values->city_name}}</option>
                                                                            @endforeach
                                                                         </select>
                                                                    </div>
                                                                </div>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (key, value) {
                    ...
                    $("table#example").append("<tr id='row" + value.id + "'><td>" + value.id + "</td><td>" + value.pin_code + "</td><td>" + value.city_name + "</td><td>" + status + "</td><td>" + editButton + deleteButton +"</td> </tr>");
                });
            }
            }
        });
