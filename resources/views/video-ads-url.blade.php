            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="py-3 mb-2">
                            <span class="text-muted fw-light">Sales & Announcements /</span> Announcements / Post Video AD's ( URL )
                        </h4>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Deactive Announcements / Post Video AD's ( URL )</p>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-medium">Active Announcements  / Post Video AD's ( URL )</p>
                                                </div>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLabel4">
                                                                        Announcements  / Post Video AD's ( URL )</h5>
                                                                ...
                                                                <form id="aws" method="POST">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row pt-3">
                                                                            <div class="col mb-0">
                                                                                <label for="">Video URL <a    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-info" data-bs-original-title="For Embeded Links Only">
                                                                                    <i class="ti-md ti ti-info-circle text-body"></i>
                                                                                </a></label>
                                                                                <input type="text" name="link"
                                                                                    id=""
                                                                                    class="form-control" placeholder="For Embeded Links Only" required>
                                                                            </div>
                                                                            <div class="col mb-0">
                                                                                <label for="">Start
                                                                                    Date</label>
                                            ...
                                            <div class="modal fade" id="exLargeModals{{ $value->id }}"
                                                ...
                                                <div class="modal-dialog modal-xl" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{url('update-video-ad-url')}}" method="POST">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col mb-0">
                                                                ...
                                                                <div class="row pt-3">
                                                                    <div class="col mb-0">
                                                                        ...
                                                                        <input type="text" name="link"
                                                                            id=""
                                                                            class="form-control" placeholder="For Embeded Links Only">
                                                                        <br>
                                                                        {!! $value->link !!}
                                                                    </div>
                                                                    <div class="col mb-0">
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            document.getElementById('aws').addEventListener('submit', function(e) {
                                ...
                                fetch("{{ url('create-video-ads-url') }}", {
                                        method: "POST",
                                        body: formData,
                                        headers: {
                                    ...
                                    .then(data => {
                                        if (data.status === 'success') {
                                            ...
                                            setTimeout(function() {
                                                ...
                                                window.location.href = '{{ url('video-ads-url') }}';
                                            }, 2000);
                                        } else {
                                            toastr.options = {
                                                "closeButton": true,
